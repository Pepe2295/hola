...
HD_PWD='/opt/Xilinx/Vivado/2018.3/bin/reloj2/reloj2.runs/design_1_reloj_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_reloj_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_reloj_0_0.tcl

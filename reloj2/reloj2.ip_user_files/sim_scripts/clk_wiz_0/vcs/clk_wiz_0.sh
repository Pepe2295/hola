...
#
# Generated by Vivado on Sun Apr 07 03:26:02 CDT 2019
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../reloj2.srcs/sources_1/bd/design_1/ipshared/85a3" +incdir+"$ref_dir/../../../../reloj2.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../reloj2.srcs/sources_1/bd/design_1/ipshared/85a3" +incdir+"$ref_dir/../../../../reloj2.srcs/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../reloj2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../reloj2.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/opt/Xilinx/Vivado/2018.3/bin/reloj2/reloj2.cache/compile_simlib/vcs"
  fi
